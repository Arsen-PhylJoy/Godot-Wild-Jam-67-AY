...
const PEC1: CompressedTexture2D = preload("res://assets/graphic/sillinesses/debug_pec_1.png")
const PEC2: CompressedTexture2D = preload("res://assets/graphic/sillinesses/debug_pec_2.png")
const PEC3: CompressedTexture2D = preload("res://assets/graphic/sillinesses/debug_pec_3.png")
